...
-- отсортировать по количеству заказов по убыванию
-- 9/11
 SELECT
	emp.employee_id,
	emp.first_name,
...
left join db_laba.dbo.orders ord on emp.employee_id = ord.salesman_id ---order by 1
...
-- 10/11
select * from
	db_laba.dbo.employees emp1 order by 2,3;
--
SELECT
...
--	inner join lfkgflkgjklfjglk
order by 1,2;

Aaron Patterson	Jaxon Ross
Abigail Palmer	Jackson Coleman
